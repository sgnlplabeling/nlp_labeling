...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/page/work/document/detail.js"></script>
		...
		<div class="full_area">
					...
					<tr>
						...
						<td>
							<c:if test="${doc.groupName == 'namedentity'}">개체명</c:if>
			  				...
			  				<c:if test="${doc.groupName == 'speech'}">화행</c:if>
		                </td>
			...
			<div class="half_area mt_25">
				...
				<div class="half_left">
					...
					<div id="brat_scroll1" class="cont_gray type_docu_detail" style="height:550px;">
				...
				<div class="half_right">
					...
					<div id="brat_scroll2" class="cont_gray type_docu_detail" style="height:550px;">
						<c:if test="${empty job}">
