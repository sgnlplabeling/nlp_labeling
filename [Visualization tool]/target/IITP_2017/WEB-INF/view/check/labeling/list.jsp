...
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/page/check/labeling/list.js"></script>
		...
		<div class="full_area">
			<div class="type_label01 clear2">
				...
				<div class="cont_win label_01">
					...
					<div class="cont_gray clear2" style="height:693px;">
				...
				<div class="label_03">
					...
					<div class="cont_win">
						...
						<div class="cont_gray clear2" style="height:190px;">
							<!-- 
							<ul id="docList" class="label_cyan_list">
								
							</ul>
							-->
							<table id="labelingDocumentList" class="tbl_scroll">
								<colgroup>
									<col style="width:70%;" />
									<col style="width:12%;" />
									<col />
...
{{if #data}}
	{{for docList}}
		<tr onclick="javascript:fn_bratView('{{>docId}}')">
