...
Util.profileStart('chunkFinish');
        ...
        $.each(data.chunks, function(chunkNo, chunk) {
          ...
          if(currentChunk.fragments.length == 1) {
            chkId = currentChunk.fragments[0].span.id;
          } else if(currentChunk.fragments.length == 2) {
            chkId = currentChunk.fragments[0].span.id + "_" + currentChunk.fragments[1].span.id
          }
