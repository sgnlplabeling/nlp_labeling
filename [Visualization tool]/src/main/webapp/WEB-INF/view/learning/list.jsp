...
<script type="text/javascript" src="/resources/js/page/learning/list.js"></script>
		...
		<div class="full_area">
			<div class="type_domain01 clear2">
				...
				<div class="cont_win domain_02">
					<form id="searchForm" action="/learning/list.do?_format=json" method="post">
					...
					<div class="mt_30">
						...
						<fieldset><legend>목록</legend>
							<form id="labeling_form" name="labeling_form" action="/learning/start.do?_format=json">
							...
							<div class="align_r mt_5">
								<a href="javascript:void(0);" class="btn b_gray medium">전체 학습 데이터 생성</a>					
