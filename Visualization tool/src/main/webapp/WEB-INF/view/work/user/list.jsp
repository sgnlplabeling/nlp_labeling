		...
		<div class="full_area">
			...
			<div class="board_top clear2">
				...
				<div class="float_r">
					...
					<a href="/work/user/edit.do?mode=C" class="btn b_orange medium valign_m">추가</a>
					</c:if>
				</div>
				<!--// 목록 표시 개수 end -->	
			</div>
									...
									<td>
										<c:choose>
											...
											<c:when test="${ sessionScope.userLoginInfo.type eq 'SUPER' }">
												<a href="/work/user/edit.do?userId=${result.userId}&mode=M" class="btn_td btn_tbl_edit">수정</a>
