...
def create_model(Model_class, path, config, logger, word_to_id, pumsa_to_id, char_to_id, tag_to_id, embedding_matrix):
	# create model, reuse parameters if exists
	model = Model_class(config, word_to_id, pumsa_to_id, char_to_id, tag_to_id, embedding_matrix)
