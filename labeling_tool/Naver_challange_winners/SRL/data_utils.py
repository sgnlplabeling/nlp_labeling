...
def inputs_from_sentences(komoran, sentences, word_to_id, pumsa_to_id, char_to_id, elmo_dict, max_char_length):
	"""
	...
	return (words1, words2, words3, words4, pumsas1, pumsas2, pumsas3, pumsas4, elmo_inputs, word1_idxs, word4_idxs, chars, [])
...
class BatchManager(object):
	...
	def pad_data(self, data, max_char_length, config):
		...
		for line in data:
			word1, word2, word3, word4, pumsa1, pumsa2, pumsa3, pumsa4, elmos, w1_idx, w4_idx, char, target = line
		...
		return [words1, words2, words3, words4,
				pumsas1, pumsas2, pumsas3, pumsas4, elmo_input, w1_idxs, w4_idxs, chars, targets]
