  ...
  with vs.variable_scope(scope or "stack_bidirectional_rnn"):
    for i, (cell_fw, cell_bw) in enumerate(zip(cells_fw, cells_bw)):
      ...
      with vs.variable_scope("cell_%d" % i) as cell_scope:
        prev_layer, state_fw, state_bw = ops_rnn.static_bidirectional_rnn(
            cell_fw,
            cell_bw,
            prev_layer,
...
def stack_bidirectional_dynamic_rnn(cells_fw,
  ...
  with vs.variable_scope(scope or "stack_bidirectional_rnn"):
    for i, (cell_fw, cell_bw) in enumerate(zip(cells_fw, cells_bw)):
      ...
      with vs.variable_scope("cell_%d" % i):
        outputs, (state_fw, state_bw), (each_state_fw, each_state_bw) = ops_rnn.bidirectional_dynamic_rnn(
            cell_fw,
            cell_bw,
            prev_layer,
            initial_state_fw=initial_state_fw,
  ...
  return prev_layer, tuple(states_fw), tuple(states_bw), (each_state_fw, each_state_bw)
