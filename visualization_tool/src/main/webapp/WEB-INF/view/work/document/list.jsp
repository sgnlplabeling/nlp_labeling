...
<script src="${pageContext.request.contextPath}/resources/lib/moment.js-2.17.1/moment-with-locales.min.js"></script>
<script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/page/work/document/list.js"></script>	
